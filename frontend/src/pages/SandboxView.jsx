...
export const SandboxView = ({ setCurrentView }) => {
  ...
  return (
    <div className={`sandbox-layout page-fade mobile-tab-${mobileTab}`}>
      {/* Mobile Tab Bar */}
      ...
      <Resizable
        left={
          ...
          <div className="sandbox-panel-lesson" style={{ padding: '20px', display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto', background: '#0c0c0e', borderRight: '1px solid var(--glass-border)' }}>
        ...
        right={
          ...
          <Resizable
            left={
              ...
              <div className="sandbox-panel-editor-result-wrapper" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                <Resizable
                  direction="vertical"
                  initialSplit={65}
                  left={
                    /* РЕДАКТОР КОДА */
                    <div className="code-editor-container sandbox-panel-editor" style={{ margin: '8px', height: 'calc(100% - 16px)' }}>
                  ...
                  right={
                    /* ПРЕВЬЮ И КОНСОЛЬ */
                    <div className="sandbox-panel-result" style={{ margin: '0 8px 8px 8px', height: 'calc(100% - 8px)', background: '#09090b', borderRadius: '8px', border: '1px solid var(--glass-border)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            right={
              ...
              <div className="ai-panel sandbox-panel-chat">
